...
import java.nio.charset.StandardCharimport java.io.BufferedReader;
import java.io.BufferedWriter;
import java.io.File;
import java.io.FileNotFoundException;
import java.io.FileReader;
 ...
 */
	...
	/*......................ChECK TEXT FILE  ..................................................................................................*/
	public void CheckTextFile() //will take String to check it in the text file 
	{
		...
		try{
			...
			{
			for(String part2 : fileInput.get(i).split("\\s+"))
			{
				String j =part2;
				VarIdList.add(j);
			...
			for (int i = 1; i < VarIdList.size(); i += 2) {    //removes every second slot in list
			    VarIdList.remove(i);							// so we only left with varID in all list
			}
			
			// here you check if the string varId matches one of the numbers in arrayList
		//	 for(int i=0;i<VarIdList.size();i++)
		//	 {
		//		 if(varId.equalto(VarIdList(i)))   VarId is the ID you want to check 
		//	 }
	...
	public void CheckMemory(String varId)
	{
		synchronized(this) {
			for(int i = 0; i < size_of_main_memory; i++) {
				if(MainMemory[i].getVarID() == varId) {
					
					//swap a value from main memory
				}
			}
	...
	public void EmptyTextFile() //this function will empty text files
	{
	...
	/*.........................PRINT ARRAYLIST TO TEXT FILE...............................................................................................*/
	
	public void PrintListToTxt() //pass arraylist to it so you can print it
	{
		PrintWriter writer3 = new PrintWriter("Output.txt", "UTF-8");  
		for(String str: VarIdList) {   //the arraylist you passing replace it with VarIdList
			  writer3.write(str+" ");
			}
			writer3.close();
	}
